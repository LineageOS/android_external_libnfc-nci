...
**                API function external definitions.
**
**                The NFC consists of several management entities:
**                     1. Device Control - controls the local device
**                     2. Device Discovery - manages discover database
**                     3. Data Channels - manages connections
**
